...
public class Verity1moredaysEntity extends Monster {
	...
	public Verity1moredaysEntity(EntityType<Verity1moredaysEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		Verity1moredaysOnInitialEntitySpawnProcedure.execute();
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		Verity1moredaysOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
