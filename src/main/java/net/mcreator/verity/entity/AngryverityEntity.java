...
public class AngryverityEntity extends Monster {
	...
	public AngryverityEntity(EntityType<AngryverityEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(10f);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		AngryverityOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
